...
<head>
	...
	<script src="https://cdn.jsdelivr.net/npm/bootstrap@5.2.1/dist/js/bootstrap.bundle.min.js"
			...
			defer></script>
    <script>
        window.open("/Survey/survey.do",'_blank',
        'toolbar=no,location=no,status=no,menubar=no,scrollbars=auto,resizable=no,directories=no,width=400,height=400,top=100,left=100');
    </script>
</head>
<body>
